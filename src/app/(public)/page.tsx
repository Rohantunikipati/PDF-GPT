      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Upload your PDFs and ask questions about their content. Get instant, accurate answers powered by advanced AI technology.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-600">Ask questions in natural language and get precise answers based on your document content.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-600">Your documents are processed securely and never stored permanently. Your privacy is our priority.</p>
            </div>
          </div>
        </div>
      </div>
